...
const Footer: React.FC<FooterProps> = ({ theme, lang }) => {
    ...
    const socialLinks = [
        {
            name: 'Email',
            href: 'mailto:dhanupandhowo29@gmail.com',
            icon: Mail,
        },
        {
            name: 'GitHub',
            href: 'https://github.com/dhanupnd',
            icon: Github,
        },
        {
            name: 'LinkedIn',
            href: 'https://www.linkedin.com/in/dhanu-pandhowo',
            icon: Linkedin,
        },
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/dhanupnd',
            icon: Instagram,
        },
    ];
