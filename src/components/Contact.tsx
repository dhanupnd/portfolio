...
const Contact: React.FC<ContactProps> = ({ theme, lang }) => {
    ...
    const socials = [
        {
            URL: 'mailto:dhanupandhowo29@gmail.com',
            icon: Mail,
            title: 'Email',
            displayURL: 'dhanupandhowo29@gmail.com',
        },
        {
            URL: 'https://github.com/dhanupnd',
            icon: Github,
            title: 'GitHub',
            displayURL: 'https://github.com/dhanupnd',
        },
        {
            URL: 'https://www.linkedin.com/in/dhanu-pandhowo',
            icon: Linkedin,
            title: 'LinkedIn',
            displayURL: 'https://www.linkedin.com/in/dhanu-pandhowo',
        },
    ];
